Feature: Checking the "true" (TypeLang\Mapper\Platform\Standard\Type\BoolLiteralType) type behavior

    Background:
        Given type "TypeLang\Mapper\Platform\Standard\Type\BoolLiteralType" with [true]
