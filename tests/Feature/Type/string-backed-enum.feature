Feature: Checking the "enum<string>" (TypeLang\Mapper\Platform\Standard\Type\BackedEnumType) type behavior
    ...
    Scenario Outline: Denormalize "<value>"
        ...
        Examples:
            ...
            ### ADDITIONAL SPECIAL CASES ###
            | "CASE"                                                | <error: Passed value "CASE" is invalid>                                |
            | "case"                                                | TypeLang\Mapper\Tests\Stub\StringBackedEnumStub::CASE                  |
            | 3735928559                                            | <error: Passed value 3735928559 is invalid>                            |
            | -3735928559                                           | <error: Passed value -3735928559 is invalid>                           |
