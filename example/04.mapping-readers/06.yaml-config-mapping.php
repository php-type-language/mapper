...
// Create standard platform with YAML CONFIG READER
$platform = new \TypeLang\Mapper\Platform\StandardPlatform(
    meta: new \TypeLang\Mapper\Mapping\Reader\YamlConfigReader(
...
//
// Because type in config file (05.php-config-mapping/ExampleDTO.yaml) is "list<bool>"
//
